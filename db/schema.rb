...
ActiveRecord::Schema.define(:version => 20120527121421) do
  ...
  create_table "rs_attendances", :force => true do |t|
  ...
  create_table "rs_members", :force => true do |t|
  ...
  create_table "rs_sessions", :force => true do |t|
